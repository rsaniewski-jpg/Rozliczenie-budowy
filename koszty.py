...
# --- PROFESJONALNY STYL CSS (Z USUNIĘCIEM TŁA IKON/LOGO) ---
st.markdown(
    """
    <style>
    ...
    /* KLUCZOWE: Usunięcie białego tła z grafik/ikon w panelu bocznym */
    [data-testid="stSidebar"] img {
        background-color: transparent !important;
        mix-blend-mode: luminosity; /* Dopasowuje kontrast grafiki do ciemnego tła */
        opacity: 0.95;
    }
    </style>
""",
